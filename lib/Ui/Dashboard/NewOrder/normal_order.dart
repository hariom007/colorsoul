...
class NormalOrder extends StatefulWidget {
  ...
  List productList = [];
  String orderid,retailerId,address,orderDate,totalAmount,retailerName,person_mobile;

  NormalOrder({Key key,this.orderid,this.productList,this.retailerId,this.address,
    this.totalAmount,this.orderDate,this.retailerName,this.person_mobile
  }) : super(key: key);
